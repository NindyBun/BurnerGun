...
public class ModContainers {
    ...
    public static final RegistryObject<ContainerType<BurnerGunContainer>> BURNERGUN_CONTAINER = CONTAINERS.register("test_gun_container", () -> IForgeContainerType.create(BurnerGunContainer::new));
